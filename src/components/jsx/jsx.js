  ...
  render(){
    return (
          ...
          <div className="description">
            <p>This Demo uses <a href="http://es6-features.org/" target="_blank" className="link">ES6</a>, <a className="link" href="https://facebook.github.io/jsx/" target="_blank">JSX</a> and babel to tranlate JSX and ES6 codes into actual Vanilla Javascript that the browser can understand. So, what is the purpose of JSX and why do we use it? we use JSX because this is what produces the actual HTML that gets inserted into the DOM. I'll show you an example on why using JSX is much better using <a className="link" href="http://babeljs.io/repl/#?evaluate=true&presets=es2015%2Creact%2Cstage-2&code=const%20App%20%3D%20function()%20%7B%0A%20%20return%20%3Cdiv%3EHello%20World!%3C%2Fdiv%3E%3B%0A%7D" target="_blank">babeljs.io</a> which is our compiler for this demo app.</p>
